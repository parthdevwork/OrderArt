...
const mapStateToProps = state => ({
	...
	orders: state.orders.rejectedOrdersList,
	isLoaded: state.orders.isRejectedOrderListLoaded
});

const _RejectedOrdersScreen = connect(
	mapStateToProps,
	bindAction
)(RejectedOrders);

export default _RejectedOrdersScreen;