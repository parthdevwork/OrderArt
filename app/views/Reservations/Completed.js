...
const CompletedReservations = (props) => {
...
const mapStateToProps = state => ({
	...
	reservations: state.reservations.completedReservationList,
	isLoaded: state.reservations.isCompletedReservationListLoaded,
});

const _CompletedReservationsScreen = connect(
	mapStateToProps,
	bindAction
)(CompletedReservations);

export default _CompletedReservationsScreen;