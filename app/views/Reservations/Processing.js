...
const ProcessingReservation = (props) => {
...
const mapStateToProps = state => ({
	...
	reservations: state.reservations.processingReservationList,
	isLoaded: state.reservations.isProcessingReservationListLoaded,
});

const _ProcessingReservationScreen = connect(
	mapStateToProps,
	bindAction
)(ProcessingReservation);

export default _ProcessingReservationScreen;